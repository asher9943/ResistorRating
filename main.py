...
def setresistor(band0, band1, band2, band3, setbtn, entry, rating, tolerance):
    ...
    if (tolerance == '1%'):
        ...
        messagebox.showerror('Tolerance', 'Unsupported Resistor Tolerance, did you remember % sign?')
...
tv['columns'] = ('Band 2 (2nd digit)', 'Band 3 (Multiplier)', 'Band 4 (Tolerance)')
tv.heading("#0", text='Band 1 (1st digit)')
tv.column("#0", anchor='center', width=125)
tv.heading('Band 2 (2nd digit)', text='Band 2 (2nd digit)')
tv.column('Band 2 (2nd digit)', anchor=W, width=125)
tv.heading('Band 3 (Multiplier)', text='Band 3 (Multiplier)')
tv.column('Band 3 (Multiplier)', anchor=W, width=125)
tv.heading('Band 4 (Tolerance)', text='Band 4 (Tolerance)')
tv.column('Band 4 (Tolerance)', anchor=W, width=125)
tv.grid(sticky = (N,S,W,E))
tv.insert('', 'end', text="0 : BLACK", values=('0 : BLACK', '.01Ω : SILVER', '1% : BROWN'))
tv.insert('', 'end', text="1 : BROWN", values=('1 : BROWN', '.1Ω : GOLD', '2% : RED'))
tv.insert('', 'end', text="2 : RED", values=('2 : RED', '1Ω : BLACK', '5% : GOLD'))
tv.insert('', 'end', text="3 : ORANGE", values=('3 : ORANGE', '10Ω : BROWN', '10% : SILVER'))
tv.insert('', 'end', text="4 : YELLOW", values=('4 : YELLOW', '100Ω : RED', ''))
tv.insert('', 'end', text="5 : GREEN", values=('5 : GREEN', '1000Ω : ORANGE', ''))
tv.insert('', 'end', text="6 : BLUE", values=('6 : BLUE', '10000Ω : YELLOW', ''))
tv.insert('', 'end', text="7 : PURPLE", values=('7 : PURPLE', '100000Ω : GREEN', ''))
tv.insert('', 'end', text="8 : GREY", values=('8 : GREY', '1000000Ω : BLUE', ''))
tv.insert('', 'end', text="9 : WHITE", values=('9 : WHITE', '', ''))
root.mainloop()